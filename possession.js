...
function possCont() {
    const potol = document.getElementById("possession");
    potol.style.display = 'block';
    ...
    const kila = document.getElementById("disciplineid");
    ...
    const piaj = document.getElementById("defendingid");
    piaj.style.display = 'none';

    const dhor = document.getElementById("passaccuracyid");
